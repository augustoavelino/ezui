#
#  Be sure to run `pod spec lint EZUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Augusto Avelino"
  # spec.authors            = { "Augusto Avelino" => "augusto_avelino@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Augusto Avelino"
